...
def mostrarMensajes():
    ...
    print(messagebox.askesno("Pregunta", "¿El o ella jugo con tu corazon?"))
    
    #Agregar funcionalidad a un boton para agregar sus botones
    def agregarBoton():
        botonVerde.config(ext="+", bg="green", fg="white")
